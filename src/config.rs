...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.183.2.250"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 10646;
pub const RELAY_PORT: i32 = 10647;
pub const WS_RENDEZVOUS_PORT: i32 =10648;
pub const WS_RELAY_PORT: i32 = 10649;
