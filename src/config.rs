...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.13.109"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 10946;
pub const RELAY_PORT: i32 = 10947;
pub const WS_RENDEZVOUS_PORT: i32 =10948;
pub const WS_RELAY_PORT: i32 = 10949;
