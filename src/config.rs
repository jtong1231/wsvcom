...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.197.34.83"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 10146;
pub const RELAY_PORT: i32 = 10147;
pub const WS_RENDEZVOUS_PORT: i32 =10148;
pub const WS_RELAY_PORT: i32 = 10149;
