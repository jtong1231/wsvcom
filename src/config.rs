...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("凌云易".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.176.27"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 10446;
pub const RELAY_PORT: i32 = 10447;
pub const WS_RENDEZVOUS_PORT: i32 =10448;
pub const WS_RELAY_PORT: i32 = 10449;
