...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("义炎宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.245.233.28"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 11546;
pub const RELAY_PORT: i32 = 11547;
pub const WS_RENDEZVOUS_PORT: i32 =11548;
pub const WS_RELAY_PORT: i32 = 11549;
