...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.197.34.85"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 10546;
pub const RELAY_PORT: i32 = 10547;
pub const WS_RENDEZVOUS_PORT: i32 =10548;
pub const WS_RELAY_PORT: i32 = 10549;
