...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.245.147.13"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 11246;
pub const RELAY_PORT: i32 = 11247;
pub const WS_RENDEZVOUS_PORT: i32 =11248;
pub const WS_RELAY_PORT: i32 = 11249;
